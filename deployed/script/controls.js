    ...
    window.addEventListener("keydown", event => {
      ...
      switch (event.keyCode) {
        ...
        case 39: //right
          ...
          this.game.player.velocityX += 1;
          this.game.image = new Image();
          this.game.player.image.src = 'pics/apolo-11/apollo-11-move-right.png'; //alters the image to simulate animation
          break;
        ...
        case 38: //up
          ...
          this.game.image = new Image();
          this.game.player.image.src = 'pics/apolo-11/apollo-11-move-up.png'; //alters the image to simulate animation
          break;

        default:
            // this.image = new Image();
            this.game.player.image.src = 'pics/apolo-11/apollo-11.png'; // resets the image
          break;
      }
    });
